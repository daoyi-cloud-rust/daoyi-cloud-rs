...
impl ErrorCode {
    pub const fn new(code: u64, msg: &'static str) -> Self {
        Self { code, msg }
    }

    pub fn to_app_error_args(&self, args: Vec<&str>) -> ApiError {
        let mut msg = self.msg.to_string();
        if args.is_empty() {
            return ApiError::Biz(self.code, msg);
        }
        for arg in args {
            msg = msg.replace("{}", arg);
        }
        ApiError::Biz(self.code, msg)
    }

    pub fn to_app_error(&self) -> ApiError {
        ApiError::Biz(self.code, self.msg.to_string())
    }
}

// ========== AUTH 模块 1-002-000-000 ==========
pub const AUTH_LOGIN_BAD_CREDENTIALS: ErrorCode =
    ErrorCode::new(1_002_000_000, "登录失败，账号密码不正确");
...
pub const MENU_EXISTS_CHILDREN: ErrorCode = ErrorCode::new(1_002_001_004, "存在子菜单，无法删除");
...
pub const ROLE_IS_DISABLE: ErrorCode = ErrorCode::new(1_002_002_004, "名字为【{}】的角色已被禁用");
pub const ROLE_ADMIN_CODE_ERROR: ErrorCode = ErrorCode::new(1_002_002_005, "标识【{}】不能使用");
...
pub const USER_IS_DISABLE: ErrorCode = ErrorCode::new(1_002_003_006, "名字为【{}】的用户已被禁用");
pub const USER_COUNT_MAX: ErrorCode = ErrorCode::new(
    1_002_003_008,
    "创建用户失败，原因：超过租户最大租户配额({})！",
);
pub const USER_IMPORT_INIT_PASSWORD: ErrorCode = ErrorCode::new(1_002_003_009, "初始密码不能为空");
pub const USER_MOBILE_NOT_EXISTS: ErrorCode = ErrorCode::new(1_002_003_010, "该手机号尚未注册");

// ========== 部门模块 1-002-004-000 ==========
pub const DEPT_NAME_DUPLICATE: ErrorCode = ErrorCode::new(1_002_004_000, "已经存在该名字的部门");
...
pub const DEPT_EXITS_CHILDREN: ErrorCode = ErrorCode::new(1_002_004_003, "存在子部门，无法删除");
...
pub const POST_NAME_DUPLICATE: ErrorCode = ErrorCode::new(1_002_005_002, "已经存在该名字的岗位");
pub const POST_CODE_DUPLICATE: ErrorCode = ErrorCode::new(1_002_005_003, "已经存在该标识的岗位");
...
pub const SMS_SEND_TEMPLATE_NOT_EXISTS: ErrorCode = ErrorCode::new(1_002_013_002, "短信模板不存在");
...
pub const TENANT_DISABLE: ErrorCode = ErrorCode::new(1_002_015_001, "名字为【{}】的租户已被禁用");
...
// ========== 租户套餐 1-002-016-000 ==========
pub const TENANT_PACKAGE_NOT_EXISTS: ErrorCode = ErrorCode::new(1_002_016_000, "租户套餐不存在");
...
pub const SOCIAL_CLIENT_NOT_EXISTS: ErrorCode = ErrorCode::new(1_002_018_210, "社交客户端不存在");
pub const SOCIAL_CLIENT_UNIQUE: ErrorCode = ErrorCode::new(1_002_018_211, "社交客户端已存在配置");
...
pub const OAUTH2_CLIENT_DISABLE: ErrorCode = ErrorCode::new(1_002_020_002, "OAuth2 客户端已禁用");
...
pub const OAUTH2_GRANT_STATE_MISMATCH: ErrorCode = ErrorCode::new(1_002_021_002, "state 不匹配");
...
// ========== 站内信模版 1-002-026-000 ==========
pub const NOTIFY_TEMPLATE_NOT_EXISTS: ErrorCode = ErrorCode::new(1_002_026_000, "站内信模版不存在");
